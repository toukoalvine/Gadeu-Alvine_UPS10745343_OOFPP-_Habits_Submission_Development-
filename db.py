...
import sqlite3 #create a database using sqlite3
...
def get_all_habits(conn):
    #eturn a list of all currently tracked active habits.
...
def get_habits_by_periodicity(db, user_id, periodicity, is_active):
    cur = db.cursor()
    cur.execute("""
        SELECT * FROM habits
